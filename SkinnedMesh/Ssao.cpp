...
CD3DX12_CPU_DESCRIPTOR_HANDLE Ssao::AlbedoMapRtv()const
{
    return mhAlbedoMapCpuRtv;
}

CD3DX12_GPU_DESCRIPTOR_HANDLE Ssao::AlbedoMapSrv()const
{
    ...
    UINT rtvDescriptorSize)
{
    ...
    rtvHandleCopy.Offset(1, rtvDescriptorSize);
    mhAlbedoMapCpuRtv = rtvHandleCopy;

    rtvHandleCopy.Offset(1, rtvDescriptorSize);
    mhAmbientMap0CpuRtv = rtvHandleCopy;

    rtvHandleCopy.Offset(1, rtvDescriptorSize);
    mhAmbientMap1CpuRtv = rtvHandleCopy;
